    ...
    <imp1:OSGINV>
      <imp1:Header>
        ...
        <imp1:CUSTOMER_TRX_ID>
          <xsl:text disable-output-escaping="no">"CUSTOMER_TRX_ID"</xsl:text>
        </imp1:CUSTOMER_TRX_ID>
        <imp1:TRX_DATE>
          <xsl:text disable-output-escaping="no">"TRX_DATE"</xsl:text>
        </imp1:TRX_DATE>
        <imp1:CUSTOMER_NAME>
          <xsl:text disable-output-escaping="no">"CUSTOMER_NAME"</xsl:text>
        </imp1:CUSTOMER_NAME>
        <imp1:ADDRESS1>
          <xsl:text disable-output-escaping="no">"ADDRESS1"</xsl:text>
        </imp1:ADDRESS1>
        <imp1:ADDRESS2>
          <xsl:text disable-output-escaping="no">"ADDRESS2"</xsl:text>
        </imp1:ADDRESS2>
        <imp1:ADDRESS3>
          <xsl:text disable-output-escaping="no">"ADDRESS3"</xsl:text>
        </imp1:ADDRESS3>
        <imp1:ADDRESS4>
          <xsl:text disable-output-escaping="no">"ADDRESS4"</xsl:text>
        </imp1:ADDRESS4>
        <imp1:CITY>
          <xsl:text disable-output-escaping="no">"CITY"</xsl:text>
        </imp1:CITY>
        <imp1:COUNTY>
          <xsl:text disable-output-escaping="no">"COUNTY"</xsl:text>
        </imp1:COUNTY>
        <imp1:STATE>
          <xsl:text disable-output-escaping="no">"STATE"</xsl:text>
        </imp1:STATE>
        <imp1:POSTALCODE>
          <xsl:text disable-output-escaping="no">"POSTALCODE"</xsl:text>
        </imp1:POSTALCODE>
        <imp1:COUNTRY>
        ...
        <imp1:EMAIL_ADDRESS>
          <xsl:text disable-output-escaping="no">"EMAIL_ADDRESS"</xsl:text>
        </imp1:EMAIL_ADDRESS>
        <imp1:INVOICE_AMOUNT>
          <xsl:text disable-output-escaping="no">"INVOICE_AMOUNT"</xsl:text>
        </imp1:INVOICE_AMOUNT>
        <imp1:ITEM_DESCRIPTION>
          <xsl:text disable-output-escaping="no">"ITEM_DESCRIPTION"</xsl:text>
        </imp1:ITEM_DESCRIPTION>
        <imp1:PAST_PAYMENT_DUE>
          <xsl:text disable-output-escaping="no">"PAST_PAYMENT_DUE"</xsl:text>
        </imp1:PAST_PAYMENT_DUE>
        <imp1:BALANCE_DUE>
          <xsl:text disable-output-escaping="no">"BALANCE_DUE"</xsl:text>
        </imp1:BALANCE_DUE>
      </imp1:Header>
...
<imp1:TRX_NUMBER>
          ...
          <!--imp1:ADDRESS1>
           <xsl:value-of select="translate(concat('&quot;',db:ADDRESS1,'&quot;'),',',' ')"/>
          </imp1:ADDRESS1>
          <imp1:ADDRESS2>
           <xsl:value-of select="translate(concat('&quot;',db:ADDRESS2,'&quot;'),',',' ')"/>
          </imp1:ADDRESS2>
          <imp1:ADDRESS3>
           <xsl:value-of select="translate(concat('&quot;',db:ADDRESS3,'&quot;'),',',' ')"/>
          </imp1:ADDRESS3>
          <imp1:ADDRESS4>
           <xsl:value-of select="translate(concat('&quot;',db:ADDRESS4,'&quot;'),',',' ')"/>
          </imp1:ADDRESS4-->
          <imp1:ADDRESS1>
