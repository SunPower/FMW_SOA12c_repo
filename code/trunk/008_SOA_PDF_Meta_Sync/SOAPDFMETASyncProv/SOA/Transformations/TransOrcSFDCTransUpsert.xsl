    ...
    <tns:upsert>
      ...
      <tns:sObjects>
        ...
        <ens:Transaction_Type__c>
          <xsl:value-of select="/ns5:MergedOracleSFDCRows/ns5:row/ns5:TRX_TYPE_MEANING"/>
        </ens:Transaction_Type__c>
         <ens:Transaction_Date__c>
          <xsl:value-of select="/ns5:MergedOracleSFDCRows/ns5:row/ns5:TRX_DATE"/>
        </ens:Transaction_Date__c>
        <ens:Partner__c>
          <xsl:value-of select="/ns5:MergedOracleSFDCRows/ns5:row/ns5:SFDC_ACCOUNT_ID"/>
        </ens:Partner__c>
        <ens:Doc_No__c>
          ...
          <xsl:value-of select="ns5:MergedOracleSFDCRows/ns5:row/ns5:PDF_FILE_NAME"/>
        </ens:Doc_No__c>
        <ens:Customer_Number__c>
          <xsl:value-of select="/ns5:MergedOracleSFDCRows/ns5:row/ns5:CUSOMER_NUMBER"/>
        </ens:Customer_Number__c>
        <ens:Attachment_Id__c>
          <xsl:value-of select="$Upsert_SDFC_OutputVariable.parameters/tns:upsertResponse/tns:result/tns:id"/>
        </ens:Attachment_Id__c>
      </tns:sObjects>
    </tns:upsert>
  </xsl:template>
