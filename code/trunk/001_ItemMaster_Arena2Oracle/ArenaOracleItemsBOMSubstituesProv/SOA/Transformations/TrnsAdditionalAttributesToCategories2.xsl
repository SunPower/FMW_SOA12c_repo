    ...
    <ns5:Categories>
      <xsl:if test="./ns9:AdditionalAttributes[@groupLabel='Arena Solutions Custom Attributes']">
        ...
        <xsl:variable name="CellTech">
         <xsl:choose>
            <xsl:when test="./ns9:AdditionalAttributes/ns9:AdditionalAttribute[@ns8:name='Cell Technology']/@ns8:value !=''">
          ...
          <xsl:variable name="MaxeonSeries">         
          <xsl:choose>
            <xsl:when test="./ns9:AdditionalAttributes/ns9:AdditionalAttribute[@ns8:name='Maxeon Series']/@ns8:value !=''">
            <xsl:value-of select="./ns9:AdditionalAttributes/ns9:AdditionalAttribute[@ns8:name='Maxeon Series']/@ns8:value"/>
        </xsl:when>
            <xsl:otherwise>
              <xsl:value-of select="'NA'"/>
            </xsl:otherwise>
        ...
        <xsl:variable name="temp2">
          <xsl:value-of select="concat($Series, $CellTech, $MaxeonSeries)"/>
        </xsl:variable>
