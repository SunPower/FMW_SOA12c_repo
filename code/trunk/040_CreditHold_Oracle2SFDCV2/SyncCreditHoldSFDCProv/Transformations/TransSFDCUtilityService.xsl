  ...
  <xsl:template match="/">
    <ns8:update>
      <ns8:CallingServiceName>
        <xsl:value-of select="SyncCreditHoldSFDCProv"/>
      </ns8:CallingServiceName>
      <xsl:for-each select="$InvSFDC_OV.parameters/ns2:queryResponse/ns2:result/ns2:records">
        ...
        <ns8:sObject>
          ...
          <xsl:choose>
            <xsl:when test="/ns1:ProcessDealer_PartnerCreditINFO/ns1:DataArea/ns0:CreditLimit/ns0:CreditLimitDetails[ns7:AccountNumber = $AccountNumber]/ns7:CreditHold='Y'">
              <ns8:Credit_Hold__c>
          ...
          <xsl:choose>
            <xsl:when test="/ns1:ProcessDealer_PartnerCreditINFO/ns1:DataArea/ns0:CreditLimit/ns0:CreditLimitDetails[ns7:AccountNumber = $AccountNumber]/ns7:CreditCheck='Y'">
              <ns8:Credit_Check__c>
                <xsl:text disable-output-escaping="no">true</xsl:text>
              </ns8:Credit_Check__c>
            </xsl:when>
