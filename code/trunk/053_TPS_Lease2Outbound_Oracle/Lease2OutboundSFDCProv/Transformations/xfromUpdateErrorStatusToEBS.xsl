    ...
    <top:XxspwrLease2OutboundDetailsCollection>
      <xsl:for-each select="/ns1:ProcessLease2Outbound/ns1:DataArea/ns9:LeaseOrder/ns9:Lease2OrderDetails">
        <top:XxspwrLease2OutboundDetails>
          <top:soNumber>
            <xsl:value-of select="ns8:SoNumber"/>
          </top:soNumber>
          <top:soaStatus>
            <xsl:text disable-output-escaping="no">ERROR</xsl:text>
          </top:soaStatus>
          <top:errorMessage>
            <xsl:text disable-output-escaping="no">SYSTEM_FAULT</xsl:text>
          </top:errorMessage>
        </top:XxspwrLease2OutboundDetails>
      </xsl:for-each>
    </top:XxspwrLease2OutboundDetailsCollection>
