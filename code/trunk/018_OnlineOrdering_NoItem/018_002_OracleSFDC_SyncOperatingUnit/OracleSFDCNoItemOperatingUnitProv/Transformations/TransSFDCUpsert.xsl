            ...
            <xsl:if test="/ns1:ProcessOracleSFDCNoItemOperatingUnit/ns1:DataArea/ns5:OracleSFDCNoItemOperatingUnit/ns5:OracleSFDCNoItemOperatingUnitDetails/ns7:ORALCE_ACCOUNT_NUMBER = $OracleAccountNumber">
               <ns2:sObjects>
                  ...
                  <xsl:choose>
                   ...
                   <xsl:choose>
                     <xsl:when test="/ns1:ProcessOracleSFDCNoItemOperatingUnit/ns1:DataArea/ns5:OracleSFDCNoItemOperatingUnit/ns5:OracleSFDCNoItemOperatingUnitDetails[ns7:ORALCE_ACCOUNT_NUMBER = $OracleAccountNumber]/ns7:CUSTOMER_GROUP=''">
                        <ens:fieldsToNull>Customer_Group__c</ens:fieldsToNull>
                     </xsl:when>
                     <xsl:otherwise>
                        <ens:Customer_Group__c>
                           <xsl:value-of select="/ns1:ProcessOracleSFDCNoItemOperatingUnit/ns1:DataArea/ns5:OracleSFDCNoItemOperatingUnit/ns5:OracleSFDCNoItemOperatingUnitDetails[ns7:ORALCE_ACCOUNT_NUMBER = $OracleAccountNumber]/ns7:CUSTOMER_GROUP"/>
                        </ens:Customer_Group__c>
                     </xsl:otherwise>
                  </xsl:choose>
               </ns2:sObjects>
