            ...
            <xsl:for-each select="">
               <inp1:UniqueIdentNum>
                  <inp1:UniqueIdentifier>
                     <xsl:value-of select="/ns1:ProcessOnlineOrderingNoItemOracleToSFDC/ns1:DataArea/ns7:OnlineOrderingNoItemOracleToSFDC/ns7:OnlineOrderingNoItemOracleToSFDCDetails/ns5:ACCOUNT_NUMBER"/>
                  </inp1:UniqueIdentifier>
               </inp1:UniqueIdentNum>
            </xsl:for-each>
            <inp1:SendEmail>
