    ...
    <top:XxspwrOmHeaderSyncCollection>
      ...
      <xsl:for-each select="$StartIndex to $EndIndex">
        ...
        <top:XxspwrOmHeaderSync>
          <top:headerId>
            <xsl:value-of select="/ns1:ProcessSyncOEOrders/ns1:DataArea/ns7:SyncOEOrders/ns7:SyncOEOrderHeaderDetails[$Index]/ns8:HEADER_ID"/>
          </top:headerId>
          <top:soaFlag>
