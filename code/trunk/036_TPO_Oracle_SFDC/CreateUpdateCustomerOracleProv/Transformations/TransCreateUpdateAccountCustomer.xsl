...
<xsl:stylesheet version="1.0" xmlns:top="http://xmlns.oracle.com/pcbpel/adapter/db/top/CreateUpdateAccountCustomer" xmlns:xp20="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.Xpath20" xmlns:bpws="http://schemas.xmlsoap.org/ws/2003/03/business-process/" xmlns:bpel="http://docs.oasis-open.org/wsbpel/2.0/process/executable" xmlns:ns2="http://www.sunpowercorp.com/Noun/SyncAccCustomers/V1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:bpm="http://xmlns.oracle.com/bpmn20/extensions" xmlns:ns0="http://www.sunpowercorp.com/Verb/VerbCommonTypes/V1" xmlns:plnk="http://schemas.xmlsoap.org/ws/2003/05/partner-link/" xmlns:tns="http://xmlns.oracle.com/pcbpel/adapter/db/TPOSOACustomerSync/CreateUpdateCustomerOracleProv/CreateUpdateAccountCustomer" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/" xmlns:ora="http://schemas.oracle.com/xpath/extension" xmlns:socket="http://www.oracle.com/XSL/Transform/java/oracle.tip.adapter.socket.ProtocolTranslator" xmlns:client="http://xmlns.oracle.com/TPOSOACustomerSync/CreateUpdateCustomerOracleProv/CreateUpdateCustomerOracleProv" xmlns:mhdr="http://www.oracle.com/XSL/Transform/java/oracle.tip.mediator.service.common.functions.MediatorExtnFunction" xmlns:ins="http://www.sunpowercorp.com/SFDCSyncLeaseCustomerReq/xsd/v1" xmlns:ns3="http://www.sunpowercorp.com/Common/CommonDataTypes/V1" xmlns:oraext="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.ExtFunc" xmlns:ns4="http://www.sunpowercorp.com/Common/SyncAccCustCommonTypes/V1" xmlns:dvm="http://www.oracle.com/XSL/Transform/java/oracle.tip.dvm.LookupValue" xmlns:hwf="http://xmlns.oracle.com/bpel/workflow/xpath" xmlns:med="http://schemas.oracle.com/mediator/xpath" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ids="http://xmlns.oracle.com/bpel/services/IdentityService/xpath" xmlns:xdk="http://schemas.oracle.com/bpel/extension/xpath/function/xdk" xmlns:xref="http://www.oracle.com/XSL/Transform/java/oracle.tip.xref.xpath.XRefXPathFunctions" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:ns1="http://www.sunpowercorp.com/BOD/ProcessSFDCSyncCust/V1" xmlns:ldap="http://schemas.oracle.com/xpath/extension/ldap" exclude-result-prefixes="xsi xsl ns2 ns0 plnk wsdl client ins ns3 ns4 xsd ns1 top tns xp20 bpws bpel bpm ora socket mhdr oraext dvm hwf med ids xdk xref ldap" xmlns:oracle-xsl-mapper="http://www.oracle.com/xsl/mapper/schemas">
  <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="WSDL">
            <oracle-xsl-mapper:schema location="../WSDLs/CreateUpdateAccountCustomer.wsdl"/>
            <oracle-xsl-mapper:rootElement name="XxspwrSforaCustomersCollection" namespace="http://xmlns.oracle.com/pcbpel/adapter/db/top/CreateUpdateAccountCustomer"/>
  ...
  <xsl:template match="/">
    <top:XxspwrSforaCustomersCollection>
      <xsl:for-each select="/ns1:ProcessSFDCSyncCust/ns1:DataArea/ns2:SyncAccCustomers/ns2:Accounts/ns2:Account">
        <top:XxspwrSforaCustomers>
          <top:tempCustId>
            <xsl:value-of select="ns4:TEMP_CUST_ID"/>
          </top:tempCustId>
          <top:customerName>
            <xsl:value-of select="ns4:CUSTOMER_NAME"/>
          </top:customerName>
          <top:accountNumber>
            <xsl:value-of select="ns4:ACCOUNT_NUMBER"/>
          </top:accountNumber>
          <top:customerClassification>
            <xsl:value-of select="ns4:ACCOUNT_TYPE"/>
          </top:customerClassification>
          <top:status>
          ...
          <top:xxspwrSforaCustSitesCollection>
            <xsl:for-each select="ns2:CustSites/ns2:CustSite">
          ...
          <top:xxspwrCustContactsCollection>
            <xsl:for-each select="ns2:Contacts/ns2:Contact">
