  ...
  <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="WSDL">
            <oracle-xsl-mapper:schema location="../WSDLs/WarrantyFDSToSFDCProv_BPEL.wsdl"/>
         ...
         <oracle-xsl-mapper:source type="WSDL">
            ...
            <oracle-xsl-mapper:param name="InvSFDCUpsert_OV.parameters"/>
         </oracle-xsl-mapper:source>
      </oracle-xsl-mapper:mapSources>
      ...
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.0.0(XSLT Build 151013.0700.0085) AT [FRI OCT 07 00:37:18 IST 2016].-->
   </oracle-xsl-mapper:schema>
