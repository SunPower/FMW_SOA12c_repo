   ...
   <xsl:template match="/">
      <inp1:CommonSFDCErrorLog>
         <inp1:CommonErrorHandlerInputDetails>
            ...
            <xsl:for-each select="/db:selectNoItemBillToFromEBSOutputCollection/db:selectNoItemBillToFromEBSOutput">
               <inp1:UniqueIdentNum>
