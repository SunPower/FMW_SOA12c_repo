    ...
    <ns7:update>
      <ns7:CallingServiceName>
       ...
       <ns7:sObject>
          ...
          <ns7:Id>
            <xsl:value-of select="ns6:SFDC_ACCOUNT_ID"/>
          </ns7:Id>
          <ns7:Oracle_Account_Number__c>
            <xsl:value-of select="ns6:ACCOUNT_NUMBER"/>
          </ns7:Oracle_Account_Number__c>
         <!-- <ns7:Customer_Interface_Status__c>
            <xsl:value-of select="boolean(ns6:PROCESS_FLAG)"/>
          </ns7:Customer_Interface_Status__c>-->
          <ns7:Customer_Interface_Error__c>
