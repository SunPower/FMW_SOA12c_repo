   ...
   <xsl:template match="/">
    <ns7:update>
      ...
      <xsl:for-each select="/ns1:ProcessSFDCSyncCustResp/ns1:DataArea/ns4:SyncAccCustomersResp/ns4:CustSitesResp/ns4:CustSiteResp[(ns6:SITE_USAGE = &quot;BILL_TO&quot;) and (ns6:SFDC_BILLTO_SITE_ID != &quot;&quot;)]">
        <ns7:sObject>
          <ns7:type>
            <xsl:value-of select="&quot;Bill_To_Site__c&quot;"/>
          </ns7:type>
          <ns7:Site_ID__c>
            <xsl:value-of select="ns6:CUST_ACCT_SITE_ID"/>
          </ns7:Site_ID__c>
          <!--<xsl:if test='ns6:LOCATION and (ns6:LOCATION != "")'>
            <ns7:Oracle_Location_id__c>
              <xsl:value-of select="ns6:LOCATION"/>
            </ns7:Oracle_Location_id__c>
          </xsl:if>-->
          <ns7:Id>
            <xsl:value-of select="ns6:SFDC_BILLTO_SITE_ID"/>
          </ns7:Id>
